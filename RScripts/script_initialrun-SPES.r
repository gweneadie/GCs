...
# initial run
runinit = GCmcmc(init = initpars, mydat = mydata, logDF = logDF.spes, priors = prior.wrapper, N = 5e2, 
...
saveRDS(object = runanother, file = paste("../results/prelim_mcmc_narrow-rh-prior_normin", Sys.Date()))
