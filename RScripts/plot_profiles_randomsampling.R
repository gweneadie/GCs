...
xrangevelPhi0 = list(c(0,20), c(0,9), c(0,40), c(0,35), c(c(0,16)))
...
####### 1. Plot MASS PROFILES for the average, compact, and extended ##########
...
####### 2. Plot velocity profiles for Average, Compact and Extended #######
...
# open file to write to
pdf(paste0("../Figures/velocityprofiles_randomsampling_", Sys.Date(), ".pdf"), width = 9, height = 8)

# set up the outer margins, inner margins, grid, etc.
par(oma=c(0,1,3,3), mai=c(1,0.6,0,0))
...
####### 3. Plot MASS PROFILES for the high Phi0 and low Phi0 results #######
...
# open file to write to
pdf(paste0("../Figures/massprofiles_diffPhi0_randomsampling_", Sys.Date(), ".pdf"), width = 9, height = 3)
...
####### 4. Plot velocity profiles for high Phi0 and low Phi0 results ###########

pdf(paste0("../Figures/velocityprofiles_randomsampling_diffPhi0_", Sys.Date(), ".pdf"), width = 9, height = 4)
